...
int main(int argc,char* argv[])
{
  ...
  n_private.param<std::string>("listen_prefix", listen_prefix,"/lbr4_allegro");
  n_private.param<std::string>("hand_prefix", hand_prefix,"/allegro_hand_right");
  n_private.param<std::string>("arm_string",arm_name,"lbr4");
  // Setup subscriber
  ...
  arm_pub=n.advertise<sensor_msgs::JointState>("/lbr4/joint_states",1);
