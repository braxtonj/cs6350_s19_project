// Publishes effort in N-m  to all the joints of KUKA lbr4 robot
...
{
	ros::init(argc,argv,"lbr4_effort_pub");
	ros::NodeHandle n;
	ros::Rate loop_rate(100);
	float joint[7]={0,0.2,0,0.1,0.5,0,0};
